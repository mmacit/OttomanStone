...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			 ...
			 */
			this.oLanguage = {
				"sProcessing": "Çalýþýyor...",
				"sLengthMenu": "Her Sayfada Gosterilecek: _MENU_",
				"sZeroRecords": "Eþleþen Veri Yok",
				"sEmptyTable": "Tabloda Veri Yok",
				"sLoadingRecords": "Yükleniyor...",
				"sInfo": " _START_ - _END_ / _TOTAL_ Girdi",
				"sInfoEmpty": "Gosterilen 0 / 0 / 0 Girdi",
				"sInfoFiltered": "(_MAX_ toplam)",
				"sInfoPostFix": "",
				"sInfoThousands": ",",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" placeholder="buraya yazin..." /><div class="srch"></div>';
